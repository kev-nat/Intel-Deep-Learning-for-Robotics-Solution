...
class BotEnv:
    ...
    def DrawEverything(self,flag=0):
        ...
        img = pygame.image.load(r"D:\Semester 5\Machine Learning for Robotics\intel robot\assets\intel.jpg")
        x, y = 580,550
        ...
        img = pygame.image.load(r"D:\Semester 5\Machine Learning for Robotics\intel robot\assets\spherelight.png")
...
if __name__ == "__main__":
    ...
    for i in range(200):
        if (random.random() > 0.5):
            ...
            GoStraight(env)
        np.savetxt(r"D:\Semester 5\Machine Learning for Robotics\intel robot\SensorData\SensorData.txt",SummarySensorData)