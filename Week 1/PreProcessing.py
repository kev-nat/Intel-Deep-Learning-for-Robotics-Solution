...
def PreprocessData():
    ...
    SensorData = np.loadtxt(r"D:\Semester 5\Machine Learning for Robotics\intel robot\SensorData\SensorData.txt")
    ...
    np.savetxt(r'D:\Semester 5\Machine Learning for Robotics\intel robot\SensorData\LabeledSensorData.txt',SensorData)
